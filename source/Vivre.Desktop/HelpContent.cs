...
public static class HelpContent
{
    ...
    [
        ...
        new HelpTopic
        {
            ...
            Tip = "Set the month's KB + build number in Settings ▸ Server 2016 cumulative update (the card holds the catalog and update-history links — copy this month's KB and build number from them), and drop the Catalog .msu in the CU package folder before staging. Shortcut: once the .msu is in the CU package folder, Settings ▸ Server 2016 cumulative update ▸ Read from package reads the KB, build number, and architecture off the file and asks you to confirm — it refuses anything that isn't a genuine Server 2016 cumulative update and never changes your values without showing you.",
        },
        new HelpTopic
        {
            ...
            Tip = "Set this month's KB + build number in Settings ▸ Server 2016 cumulative update before staging or using \"Install minor updates only\" — both need to know which update is the cumulative one. Flagging is remembered between sessions. Shortcut: once the .msu is in the CU package folder, Settings ▸ Server 2016 cumulative update ▸ Read from package reads the KB, build number, and architecture off the file and asks you to confirm — it refuses anything that isn't a genuine Server 2016 cumulative update and never changes your values without showing you.",
        },
        new HelpTopic
        {
