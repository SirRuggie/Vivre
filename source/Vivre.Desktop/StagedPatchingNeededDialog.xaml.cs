...
/// <summary>
/// Guidance shown when the operator clicks a staged-only Server 2016 panel action (Stage / Verify) but no box
...
/// no box is touched. Shown BEFORE any action runs, mirroring the Stage button's package pre-check. (Clean up
/// is decoupled from staged-state and never triggers this dialog.)
/// </summary>
